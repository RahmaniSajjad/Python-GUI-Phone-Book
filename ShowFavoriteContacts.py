...
class Ui_Form_ShowFavoriteContacts(object):
    def setupUi(self, Form, w, h, f):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("file/showFavoriteContact.ico"))
        Form.setWindowIcon(icon)

        self.widget = QtWidgets.QWidget(Form)
        self.widget.setGeometry(QtCore.QRect(
            int(0 * ratio_w), int(0 * ratio_h), int(1380 * ratio_w), int(917 * ratio_h)))
        self.widget.setStyleSheet("border-image : url('file/showFavoriteContact_background.jpg');")
        ...
        self.change_sort_comboBox.addItem("")
        # Change sort action
        with open("file/sort_favoriteContact_currentIndex.txt", "rt") as file:
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Show Favorite Contacts"))
    ...
    def change_sort_action(self):
        ...
        with open("file/sort_favoriteContact_currentIndex.txt", "wt") as file:
    ...
    def tableWidget_action_show(self, Form):
        ...
        self.widget.setStyleSheet("border-image : url('file/showSingleFavoriteContact_background.png');")
        ...
        self.sound_pushButton.setGeometry(QtCore.QRect(
            int(210 * ratio_w), int(210 * ratio_h), int(34 * ratio_w), int(36 * ratio_h)))
        ...
        self.copy_to_clipboard_pushButton.setGeometry(QtCore.QRect(
            int(260 * ratio_w), int(700 * ratio_h), int(200 * ratio_w), int(35 * ratio_h)))
        ...
        self.delete_from_favorite_pushButton = QtWidgets.QPushButton(self.single_contact_widget)
        self.delete_from_favorite_pushButton.setGeometry(QtCore.QRect(
            int(315 * ratio_w), int(660 * ratio_h), int(90 * ratio_w), int(30 * ratio_h)))
        self.delete_from_favorite_pushButton.setFlat(True)
        self.delete_from_favorite_pushButton.setStyleSheet(
            f"border :1px solid black;border-radius :{int(15 * (ratio_w + ratio_h) / 2)}px;" + "color:#550000;")
        self.delete_from_favorite_pushButton.setFont(QtGui.QFont("Gabriola", int(20 * ratio_font)))
        self.delete_from_favorite_pushButton.setText("Delete")
        self.delete_from_favorite_pushButton.clicked.connect(
            lambda: self.delete_from_favorite_action(self.single_contact_widget, Form))
    ...
    def delete_from_favorite_action(self, single_contact_widget, Form):
        ...
        MessageBox.information(
            single_contact_widget, 'Result', 'Contact successfully removed from favorite.', MessageBox.Ok)
    ...
    def sound_action(self):
        ...
        you can send they email by {self.email_lineEdit.text()}.
